...
export class EditTabDialog extends LitElement {
  ...
  private handleSave() {
    ...
    if (this.isEditMode() && this.tab) {
      this.dispatchEvent(new CustomEvent('edit-tab', {
        detail: { id: this.tab.id, ...eventDetail },
        bubbles: true
      }));
    } else {
      this.dispatchEvent(new CustomEvent('add-tab', {
        detail: eventDetail,
        bubbles: true
      }));
    }
        ...
        <div class="modal">
          ...
          <div class="footer">
            <div class="footer-left">
              ${this.isEditMode() && this.canDelete ? html`
      ...
      ${this.showDeleteConfirm ? html`
        <div class="confirm-overlay" @click=${(e: Event) => {
          ...
          <div class="confirm-modal">
            ...
            <p class="confirm-message">Are you sure you want to delete this tab? All widgets in this tab will also be deleted. This action cannot be undone.</p>
